...
class BGMWorker(QThread):
    ...
    def __init__(self, mode, input_path, bgm_file, output_path, volume, use_cuda, notif_topic, ffmpeg_path="ffmpeg"):
        ...
        self.ffmpeg_path = ffmpeg_path  # allow custom ffmpeg binary path
...
class MainWindow(QWidget):
    def __init__(self):
        ...
        # Set the window size to 700x800
        self.resize(700, 800)
    ...
    def start_processing(self):
        ...
        # If you're bundling ffmpeg with your app, set the ffmpeg_path appropriately
        ffmpeg_path = os.path.join(os.path.dirname(sys.executable), "ffmpeg") if getattr(sys, 'frozen', False) else "ffmpeg"
