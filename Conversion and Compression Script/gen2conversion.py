...
# =============================================================================
INPUT_ROOT = r"K:\REAP 15 Course 2024\720p"       # <-- Change to your input root folder
OUTPUT_ROOT = r"W:\Youtube Project scripts\6. Automation Script\0. Converstion Script"  # <-- Output folder (outside the input)
...
def convert_video_file(input_file: str, output_file: str) -> None:
    ...
    and 320k audio bitrate. This function now checks for ffmpeg errors and prints stderr.
    """
    ...
    command = [
        ...
        "-hwaccel", "cuda",         # Use NVIDIA GPU acceleration (try removing this if errors occur)
        "-i", input_file,
